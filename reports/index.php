                    ...
                    <div class="field">
                        ...
                        <select name="report" id="report" required>
                            ...
                            <optgroup label="Colaboradores">
                                ...
                                <option value="colaboradores_por_sector">10. Colaboradores por setor</option>
                            </optgroup>

                            <!-- Fardas -->
                            <optgroup label="Fardas">
                                <option value="fardas_mais_atribuidas">11. Fardas mais atribuídas</option>
                                <option value="fardas_menos_atribuidas">12. Fardas menos atribuídas</option>
                                <option value="stock_atual">13. Stock atual completo</option>
                                <option value="stock_baixo">14. Stock baixo (abaixo do mínimo)</option>
                                <option value="compras_periodo">15. Compras de fardas por período</option>
                                <option value="devolucoes_motivo">16. Devoluções por motivo / estado</option>
                            </optgroup>

                            <!-- Cacifos -->
                            <optgroup label="Cacifos">
                                <option value="cacifos_lista">17. Lista completa de cacifos</option>
                                <option value="cacifos_ocupados">18. Cacifos ocupados</option>
                                <option value="cacifos_livres">19. Cacifos livres</option>
                                <option value="cacifos_avariados">20. Cacifos avariados</option>
                                <option value="cacifos_colabs_inativos">21. Cacifos de colaboradores inativos</option>
                            </optgroup>

                            <!-- Financeiros -->
                            <optgroup label="Financeiros">
                                <option value="valor_total_stock">22. Valor total em stock</option>
                                <option value="custo_por_colaborador">23. Custo de fardamento entregue por colaborador</option>
                                <option value="custo_por_departamento">24. Custo total por departamento</option>
                                <option value="custo_total_fardas">25. Custo total de fardas (atribuídas + stock)</option>
                            </optgroup>

                            <!-- Diversos -->
                            <optgroup label="Diversos">
                                <option value="logs_filtrados">26. Logs de sistema filtráveis</option>
                                <option value="export_ean">27. Export EAN / códigos de barras (CSV)</option>
                                <option value="print_ean">28. Imprimir EAN (etiquetas a partir dos PNGs)</option>
                                <option value="itens_sem_ean">29. Itens de farda sem EAN</option>
                                <option value="historico_atribuicoes">30. Histórico de atribuições</option>
                            </optgroup>
                        </select>
                    </div>
...
<script>
    ...
    const todasColunasMap = {
        ...
        colaboradores_por_sector:      ['Setor','Departamento','Nome','Cartão','Telefone','Email','Ativo'],
    ...
    const dadosPessoaisMap = {
        ...
        colaboradores_por_sector:      ['Nome', 'Cartão', 'Telefone', 'Email'],
